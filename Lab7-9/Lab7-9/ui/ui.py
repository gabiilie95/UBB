...
class Ui():
    ...
    def __init__(self, filmController, clientController, rentController, clientRepository):
    ...
    def showRents(self):
        for rent in self.__rentController.getAllRents():
            print ("ID client: " + rent.getIDC() + "    ID film: " + rent.getIDF() + "    is rented: " + str(rent.getIsRented()))
